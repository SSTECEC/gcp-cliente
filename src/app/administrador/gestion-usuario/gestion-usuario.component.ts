...
export class GestionUsuarioComponent implements OnInit {
  ...
  public listarUsuarios() {
    this.spinner.show();
    this.connection.get("listarUsuarios", "").subscribe(
      (res: any) => {
    ...
    if(this.globales.validarModalCrearUsuario(this.fmrUsuario,this.foto)){
      ...
      this.connection.post("guardarUsuario", datos, "").subscribe(
        (res: any) => {
          ...
          if (res) {
            this.globales.notificacion("Usuario Creado Exitosamente", "success", "top");
          }
          this.spinner.hide();
          location.reload();
        },
  ...
  public actualizarUsuario() {
    ...
    if(this.globales.validarModalActualizarUsuario(this.fmrUsuario)){
  ...
  public eliminarUsuario(id: any) {
    ...
    this.spinner.show();
    this.connection.post("eliminarUsuario", datos, "").subscribe(
      (res: any) => {
        
        if (res) {
          this.listarUsuarios();
          this.globales.notificacion("Usuario Eliminado Exitosamente", "success", "top");
        }
        this.spinner.hide();
      },
      err => {
