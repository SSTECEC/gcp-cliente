...
@Component({
  selector: 'app-supervisor-rev',
  templateUrl: './supervisor-rev.component.html',
  styleUrls: ['./supervisor-rev.component.css']
})
export class SupervisorRevComponent implements OnInit {
