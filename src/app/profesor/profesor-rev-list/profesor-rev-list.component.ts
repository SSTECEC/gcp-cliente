...
@Component({
  selector: 'app-profesor-rev-list',
  templateUrl: './profesor-rev-list.component.html',
  styleUrls: ['./profesor-rev-list.component.css']
})

export class ProfesorRevListComponent implements OnInit {
