...
@Component({
  selector: 'app-responsable-lista-reservas',
  templateUrl: './responsable-lista-reservas.component.html',
  styleUrls: ['./responsable-lista-reservas.component.css']
})
export class ResponsableListaReservasComponent implements OnInit {
